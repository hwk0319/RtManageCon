...
<html>
  <head>
	...
	<link href="${pageContext.request.contextPath}/jsp/plugins/Cron/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/jsp/plugins/Cron/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/jsp/plugins/Cron/Cron/icon.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .line
        {
            height: 25px;
  ...
  <body>
    <center style="width:100%;">
        <div class="easyui-layout" style="width:100%;height:100%;border: 1px rgb(202, 196, 196) solid;border-radius: 5px;">
          ...
          <!--               <div class="line">
                            ...
                            秒</div> -->
                        <div class="line">
                            <input type="radio" checked="checked"  name="second" onclick="startOn(this)">
                            
                            <input  class="numberspinner  hiddspinner" style="width:60px;" data-options="" value="0"
                                id="secondStart_1">
                          每
           ...
           <!--              <div class="line">
             ...
             <!--            <div class="line">
                            ...
                            分钟</div> -->
                        <div class="line">
                            <input type="radio" checked="checked" name="min" onclick="startOn(this)">
                            
                            <input class="numberspinner hiddspinner" style="width: 60px;" data-options="min:0,max:59" value="0"
                                id="minStart_1">
                            每
                            <input class="numberspinner" style="width: 60px;" data-options="min:1,max:59" value="1"
                                id="minEnd_1">
          ...
          <!--           <div title="年">
            ...
            <div data-options="region:'south',border:false" style="height:250px;display:none;">
    ...
    <script src="${pageContext.request.contextPath}/jsp/plugins/Cron/Cron/jquery-1.8.3.min.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/jsp/plugins/Cron/Cron/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/jsp/plugins/Cron/Cron/cron.js" type="text/javascript"></script>
    <script type="text/javascript">
       $(function(){
    		$(".hiddspinner").parent().css({display:"none"});
    		$(".hiddspinner").parent().css({display:"none"});
       });
    </script>
  </body>
