...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/pages/configmgt/devmonimgt/js/devmonimgtt.js"></script>
...
<body>
	   	...
	   	<div class="">
				<div class="prom-3">
					...
					<div class="w_p30">
						...
						<select style="width:70%;font-size:12px;" id="indextype_id">
							<option value=" " selected>--请选择--</option>
						</select>
					</div>
					<div class="w_p30">
						<button id="devmonSrch" class="btn"><i class="icon-search"></i> 查询</button>
					</div>
				</div>
			</div>
	  </div>
	...
	<div id="main_list" style="margin:1%">
		<table id="jqGridListDevmon"></table>
		<div id="jqGridPaperListDevmon"></div>
	</div>
