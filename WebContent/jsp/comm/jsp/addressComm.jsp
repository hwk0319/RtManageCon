...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/comm/js/addressComm.js"></script>
<style>
	.ui-jqdialog-title{
		color: black;
	}
...
<body>
	<div class="" style="height:35px;">
			<div class="prom-3"  style="margin-left: 0px;width: 100%;margin-top: 0px;">
				<div class="w_p30">
					...
					<input type="text" id="name_search" style="height: 20px;">
				</div>
				<div class="w_p30">
					<span class="txt">手机号:</span>
					<input type="text" id="phone_search" style="height: 20px;">
				</div>
				<div class="w_p30">
	...
	<div id="main_list">
		<table id="jqGridListAddress"></table>
		<div id="jqGridPagerListAddress"></div>
	</div>
</body>
