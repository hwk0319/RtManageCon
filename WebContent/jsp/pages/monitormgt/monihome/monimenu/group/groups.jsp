...
<link rel="stylesheet" type="text/css"  href="${pageContext.request.contextPath}/jsp/pages/monitormgt/monihome/monimenu/group/css/groups.css" />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/pages/monitormgt/monihome/monimenu/group/js/groups.js"></script>
<style>
body{
...
<div class="contain">
	<div class="search">
		...
		<blockquote class="layui-elem-quote layui-quote-nm">
			<div class="hint">您好，欢迎访问组监控页面，共 <span class="total"></span> 个组，其中故障台数为：<span class="error" style="color:red"></span></div>
			<div class="search-txt">
				<div class="txt">
					<input id="kw" type="text" placeholder="请输入组名称" style="height: 23px;"/>
				</div>
