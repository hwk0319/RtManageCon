...
//				   {label:'描述',name:'description',index:'description',width:80,align:'center'},
		...
		caption:"<div style='color:#000;width:95%;'>健康评分<span  id='heathAdd'  onclick='doInsert()' style='float:right;cursor:pointer;'><i class='icon-plus-sign'></i>&nbsp;新增</span></div>",
		height:'auto',
		autowidth:true,
...
//                vw = "<a href=# title='详情' onclick='doView("+ids[i]+");'>详情 </a>";
                ...
                jQuery("#jqGridListHea").jqGrid('setRowData',ids[i],{act:JY+" "+pf+" "+sz+" "+ed+" "+vi});
            } 
        }
	});
}
